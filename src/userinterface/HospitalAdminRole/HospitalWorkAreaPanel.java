 ...
 * @author khushbu
 */
public class HospitalWorkAreaPanel extends javax.swing.JPanel {
    ...
    public HospitalWorkAreaPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecosystem) {
...
//        manageSessions.setForeground(nonActiveTxtColor);
    ...
    private void managePersonalInfo() {
        ...
        Hospital hospital = (Hospital) userAccount;
        HospitalPersonalInformation hospitalPersonalInformation = new HospitalPersonalInformation(mainPanel, ecosystem, hospital, true);
        // HospitalDashboard hospitalDashboard = new HospitalDashboard(mainPanel, ecosystem, userAccount);

        mainPanel.add("hospitalPersonalInformation", hospitalPersonalInformation);
        CardLayout layout = (CardLayout) mainPanel.getLayout();
        layout.next(mainPanel);
    }
}
