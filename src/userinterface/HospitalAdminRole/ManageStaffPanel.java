...
import userinterface.HospitalAdminRole.AddDepartmentPanel;
...
public class ManageStaffPanel extends javax.swing.JPanel {
    ...
    public ManageStaffPanel(JPanel parentContainerPanel, EcoSystem ecosystem,UserAccount userAccount) {
    ...
    private Staff getSelectedStaff() {
        ...
        Staff u = (Staff) tblDepartmentList.getValueAt(selectedRowIndex, 1);

        return u;
    }

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        Staff u = getSelectedStaff();

        if (u != null) {
            AddStaffPanel addStaff = new AddStaffPanel(userProcessContainer, ecosystem, u, true, userAccount);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (u != null) {
            ...
            HospitalDepartment hdd = hospital.getDepartmentDirectory().getHospitalDepartmentByName(u.getDepartment().getDepartmentName());
    ...
    private void populateTable() {
        ...
        if (hdd != null) {
            ...
            for (HospitalDepartment depart : hdd.getDepartmentList()) {
                for(Staff st: depart.getStaffDirectory().getStaffList()){
    ...
    private void btnAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserActionPerformed
        ...
        AddStaffPanel addStaff = new AddStaffPanel(userProcessContainer, ecosystem, null, false,userAccount);
