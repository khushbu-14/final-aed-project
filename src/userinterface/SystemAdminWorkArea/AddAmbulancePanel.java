 ...
 * @author khushbu
 */
public class AddAmbulancePanel extends javax.swing.JPanel {
     ...
     * @param isUpdatePage
     */
    public AddAmbulancePanel(JPanel mainWorkArea, EcoSystem ecosystem, AmbulanceService amb, Boolean isUpdatePage) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblUserAction.setText("Add Ambulance");
        ...
        btnSignup.setText("Add Ambulance");
    ...
    private void setData() {
        ...
        if (isUpdatePage) {
            ...
            txtSUserName.setText(amb.getUsername());
            txtSPassword.setText(amb.getPassword());
            txtSAddress.setText(amb.getAddress());
            txtSName.setText(amb.getName());
            txtContact.setText(amb.getContact());
            txtSEmail.setText(amb.getEmail());
    ...
    private void backAction() {
        ...
        ManageAmbulancePanel manageAmbulancePanel = (ManageAmbulancePanel) component;

        manageAmbulancePanel.refreshTable();
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        ...
        if (!util.isStringInputValid(userName)) {
            ...
            if (isUpdatePage) {
                ...
                ecosystem.getAmbulanceDirectory().addNewAmbulanceService(ambTemp);
                ecosystem.getUserAccountDirectory().addUserAccount(ambTemp);
            }
