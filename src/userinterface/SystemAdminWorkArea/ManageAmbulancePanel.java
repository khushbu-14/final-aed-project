...
public class ManageAmbulancePanel extends javax.swing.JPanel {
    ...
    public ManageAmbulancePanel(JPanel parentContainerPanel, EcoSystem ecosystem) {
    ...
    private void initComponents() {
        ...
        tblAmbulanceList = new javax.swing.JTable();
        ...
        tblAmbulanceList.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        tblAmbulanceList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblAmbulanceList.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tblAmbulanceList.setSelectionBackground(new java.awt.Color(0, 102, 204));
        jScrollPane1.setViewportView(tblAmbulanceList);
        ...
        lblTitle.setText(" Manage Ambulance Service");
    ...
    private int getSelectedRow() {
        int selectedRowIndex = tblAmbulanceList.getSelectedRow();
        return selectedRowIndex;
    }

    private AmbulanceService getSelecteAmbulanceService() {
        int selectedRowIndex = tblAmbulanceList.getSelectedRow();

        if (selectedRowIndex < 0) {
            utils.showErrorToast("Oops! Please select an Ambulance Service first.");
            return null;
        }

        AmbulanceService u = (AmbulanceService) tblAmbulanceList.getValueAt(selectedRowIndex, 1);

        return u;
    }

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        AmbulanceService u = getSelecteAmbulanceService();

        if (u != null) {
            AddAmbulancePanel addAmbulance = new AddAmbulancePanel(userProcessContainer, ecosystem, u, true);

            userProcessContainer.add("AddAmbulancePanel", addAmbulance);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (u != null) {
            AmbulanceDirectory ud = ecosystem.getAmbulanceDirectory();

            ud.deleteAmbulanceService(u);
    ...
    private void populateTable() {
        AmbulanceDirectory aDir = ecosystem.getAmbulanceDirectory();

        if (aDir != null) {
            DefaultTableModel model = (DefaultTableModel) tblAmbulanceList.getModel();

            model.setRowCount(0);
            int count = 1;

            for (AmbulanceService amb : aDir.getAmbulanceList()) {

                Object[] row = new Object[8];
                row[0] = "" + count++;
                row[1] = amb;
                row[2] = amb.getUsername();
                row[3] = amb.getPassword();
                row[4] = amb.getEmail();
                row[5] = amb.getContact();
                row[6] = amb.getAddress();
                row[7] = amb.getZipcode();
    ...
    private void btnAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserActionPerformed
        ...
        AddAmbulancePanel addAmbulance = new AddAmbulancePanel(userProcessContainer, ecosystem, null, false);
    ...
    private javax.swing.JTable tblAmbulanceList;
