...
public class ManageDeliverymanPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnAddUser.setText("DeliveryMan");
    ...
    private DeliveryMan getSelectedDeliveryman() {
        ...
        if (selectedRowIndex < 0) {
            utils.showErrorToast("Oops! Please select a DeliveryMan first.");
            return null;
        }

        DeliveryMan u = (DeliveryMan) tblDeliverymanList.getValueAt(selectedRowIndex, 1);

        return u;
    }

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        DeliveryMan u = getSelectedDeliveryman();

        if (u != null) {
            AddDeliverymanPanel addDeliveryman = new AddDeliverymanPanel(userProcessContainer, ecosystem, u, true);

            userProcessContainer.add("AddDeliverymanPanel", addDeliveryman);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (u != null) {
            DeliveryManDirectory ud = ecosystem.getDeliveryManDirectory();

            ud.deleteDeliveryMan(u);
    ...
    private void populateTable() {
        DeliveryManDirectory dDir = ecosystem.getDeliveryManDirectory();
...
//                if (dlv != null) {
                ...
                row[4] = dlv.getEmail();
                row[5] = dlv.getContact();
                row[6] = dlv.getAddress();
...
//                }
    ...
    private void btnAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserActionPerformed
        ...
        AddDeliverymanPanel addDelivery = new AddDeliverymanPanel(userProcessContainer, ecosystem, null, false);

        userProcessContainer.add("AddDeliveryPanel", addDelivery);
